...
export interface ApiBuildingBuilding extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    qr_link: Schema.Attribute.String;
    refreshVersion: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
export interface ApiOfficeOffice extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    floor: Schema.Attribute.Relation<'oneToOne', 'api::floor.floor'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::office.office'
    ...
    qr_extra_url: Schema.Attribute.String;
    qr_link: Schema.Attribute.Text;
    qr_main_url: Schema.Attribute.String;
    qr_whatsapp_url: Schema.Attribute.String;
    schedule_text: Schema.Attribute.String;
    sector: Schema.Attribute.String;
    state: Schema.Attribute.Enumeration<['ocupada', 'libre', 'reservad']> &
      Schema.Attribute.DefaultTo<'ocupada'>;
